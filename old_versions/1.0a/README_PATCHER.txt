PAL4 English Mod v1.0 - Patch Guide

Two ways to install:
  A) Downloader-installer (small, ~16 MB): Download the installer exe from GitHub Releases and run it — it auto-downloads the patch for you.
  B) Manual patch zip (~1.3 GB): Use the zip you already have (this folder came from it).

For Option A, you don't need this folder. Just run the installer exe.

For Option B, follow the manual copy steps below.
...
2. Open this 1.0a/1.0b patch folder.
